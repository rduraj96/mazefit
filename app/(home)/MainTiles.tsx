  ...
  return (
    <section className="relative py-3 px-7">
      ...
      <div className="grid grid-cols-4 grid-rows-1 h-44 gap-x-7 gap-y-6 my-5">
        <MainCard className="bg-foreground cursor-pointer">
        ...
        <MainCard className="bg-foreground hover:shadow-[#867BFC] shadow-md cursor-pointer">
          <div className="flex gap-3 p-4 items-center">
        ...
        <MainCard className="bg-foreground hover:shadow-[#51D8D8] shadow-md cursor-pointer">
          <div className="flex gap-3 p-4 items-center">
            <MdAccessTimeFilled size={30} />
        ...
        <MainCard className="bg-foreground hover:shadow-[#F97A4D] shadow-md cursor-pointer">
          <div className="flex gap-3 p-4 items-center">
